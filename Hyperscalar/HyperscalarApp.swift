...
struct HyperscalarApp: App {
    ...
    private func handleIncomingURL(_ url: URL) {
        guard url.scheme == "hyperscalar" else { return }
...
class UpdateChecker: NSObject, ObservableObject, URLSessionDownloadDelegate {
    ...
    private let repoName = "Hyperscalar"
    ...
    nonisolated func urlSession(_ session: URLSession, downloadTask: URLSessionDownloadTask, didFinishDownloadingTo location: URL) {
        let tempDmg = FileManager.default.temporaryDirectory.appendingPathComponent("Hyperscalar_Update.dmg")
    ...
    private func installUpdate(dmgPath: String) {
        ...
        let script = """
        (
            exec > /tmp/hyperscalar_update.log 2>&1
            echo "Starting update..."
            sleep 3
            MOUNT_POINT="/tmp/HyperscalarUpdate_$(date +%s)"
            mkdir -p "$MOUNT_POINT"
            hdiutil mount "\(dmgPath)" -mountpoint "$MOUNT_POINT" -quiet
            
            if [ -d "$MOUNT_POINT/Hyperscalar.app" ]; then
                echo "Found new app, replacing..."
                rm -rf "\(appPath)"
                ditto "$MOUNT_POINT/Hyperscalar.app" "\(appPath)"
...
class LanguageService: ObservableObject {
    ...
    private let translations: [Language: [String: String]] = [
        .turkish: [
            ...
            "update_available_message": "Hyperscalar'in yeni sürümü (v%@) hazır. Şimdi indirmek ister misiniz?",
            "later": "Daha Sonra",
            ...
            "safari_warning": "Not: Safari çerezleri için Sistem Ayarları > Gizlilik ve Güvenlik > Tam Disk Erişimi kısmından Hyperscalar'e izin vermeniz gerekir. Safari dışı bir tarayıcı (Chrome, Brave vb.) kullanmanız çok daha kolay olacaktır.",
            ...
            "share_msg_x": "#Hyperscalar ile videoları zahmetsizce indirin! 🚀 macOS üzerindeki en iyi yerel deneyim. https://github.com/offsideai/Hyperscalar",
            "share_msg_mastodon": "#Hyperscalar ile videoları zahmetsizce indirin! 🚀 macOS üzerindeki en iyi yerel deneyim. https://github.com/offsideai/Hyperscalar",
            "share_msg_bluesky": "#Hyperscalar ile videoları zahmetsizce indirin! 🚀 macOS üzerindeki en iyi yerel deneyim. https://github.com/offsideai/Hyperscalar",
            "share_msg_threads": "#Hyperscalar ile videoları zahmetsizce indirin! 🚀 macOS üzerindeki en iyi yerel deneyim. https://github.com/offsideai/Hyperscalar",
            ...
            "quit": "Çıkış",
            "open_hyperscalar": "Hyperscalar'i Aç",
        ...
        .english: [
            ...
            "clear": "Clear",
            "format": "Format",
            "support_btn": "Support Hyperscalar",
            ...
            "update_available_message": "A new version of Hyperscalar (v%@) is ready. Would you like to download it now?",
            "later": "Later",
            "restart": "Restart",
            ...
            "safari_warning": "Note: For Safari cookies, you must grant 'Full Disk Access' to Hyperscalar in System Settings > Privacy & Security. Using a browser other than Safari (Chrome, Brave, etc.) will be much easier.",
            ...
            "share_msg_x": "Downloading videos effortlessly with #Hyperscalar! 🚀 Best native experience on macOS. https://github.com/offsideai/Hyperscalar",
            "share_msg_mastodon": "Downloading videos effortlessly with #Hyperscalar! 🚀 Best native experience on macOS. https://github.com/offsideai/Hyperscalar",
            "share_msg_bluesky": "Downloading videos effortlessly with #Hyperscalar! 🚀 Best native experience on macOS. https://github.com/offsideai/Hyperscalar",
            "share_msg_threads": "Downloading videos effortlessly with #Hyperscalar! 🚀 Best native experience on macOS. https://github.com/offsideai/Hyperscalar",
            ...
            "quit": "Quit",
            "open_hyperscalar": "Open Hyperscalar",
