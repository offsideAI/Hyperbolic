...
<div align="center">
  <img src="Hyperscalar/Resources/Assets.xcassets/AppIcon.appiconset/icon_128x128.png" width="128" />
  <p>
    <a href="https://github.com/offsideai/Hyperscalar/releases/latest/download/Hyperscalar-v3.1.0.dmg">
      <img src="https://img.shields.io/badge/Download-macOS-blue?style=for-the-badge&logo=apple&logoColor=white" alt="Download Hyperscalar for macOS" />
    </a>
    <a href="https://github.com/offsideai/homebrew-hyperscalar">
    ...
    <a href="https://github.com/offsideai/Hyperscalar/releases">
      <img src="https://img.shields.io/github/downloads/offsideai/Hyperscalar/total?style=for-the-badge&color=818cf8" alt="Total Downloads" />
    </a>
  </p>
  <p>
    <a href="https://mastodon.social/@hyperscalar_app">
    ...
    <a href="https://bsky.app/profile/hyperscalarapp.bsky.social">
    ...
    <a href="https://x.com/hyperscalar_app">
      <img src="https://img.shields.io/badge/Follow-X-black?style=for-the-badge&logo=x&logoColor=white" alt="Follow on X" />
    </a>
  </p>
</div>

Hyperscalar is a native macOS frontend for the powerful [yt-dlp](https://github.com/yt-dlp/yt-dlp) command-line tool. It allows you to download videos and audio from YouTube and thousands of other supported sites with ease.
...
Direct financial support via GitHub Sponsors is currently disabled due to local tax and regulatory complexities. While I truly appreciate the generosity of everyone who wanted to contribute, the best way to support Hyperscalar right now is by **starring the repository**, reporting bugs, or sharing the project with the community. Thank you for understanding! 🙏

### 🏆 The "First 5" Wall of Fame
To show my gratitude, the **first 5 sponsors** of any amount will be **permanently featured** in the "About" section of the Hyperscalar app. Your name will be part of the app's history forever!
...
Here is what I'm planning to bring to Hyperscalar in the near future:
...
```bash
brew tap offsideai/hyperscalar
brew install --cask hyperscalar
xattr -cr /Applications/Hyperscalar.app
```

### Option 2: Manual Download

- **Download:** Download the latest `Hyperscalar-v3.0.0.dmg` from the [Releases](https://github.com/offsideai/Hyperscalar/releases) page.
- **Install:** Open the DMG file and drag **Hyperscalar** to your `Applications` folder.
...
#### Chrome / Brave / Edge:
1. **Download:** [HyperscalarExtension_Chrome.zip](https://github.com/offsideai/Hyperscalar/releases/download/v3.0.0/HyperscalarExtension_Chrome.zip) and unzip it.
2. Go to `chrome://extensions/`
3. Enable **"Developer mode"** (top right).
4. Click **"Load unpacked"** and select the unzipped folder.

#### Firefox:
1. **Download:** [HyperscalarExtension_Firefox.zip](https://github.com/offsideai/Hyperscalar/releases/download/v3.0.0/HyperscalarExtension_Firefox.zip) and unzip it.
2. Go to `about:debugging#/runtime/this-firefox`
3. Click **"Load Temporary Add-on..."**.
4. Select the `manifest.json` file inside the unzipped folder.

> 💡 **Usage:** Once installed, simply **right-click** on any video link or the page itself on supported sites (like YouTube) and select **"Download with Hyperscalar"** to start downloading immediately.
...
Videos on YouTube and other sites may be subject to DMCA protection. The authors of Parabolic/Hyperscalar do not endorse, and are not responsible for, the use of this application in means that will violate these laws.
...
[![Star History Chart](https://api.star-history.com/svg?repos=offsideai/Hyperscalar&type=date&legend=top-left)](https://www.star-history.com/#offsideai/Hyperscalar&type=date&legend=top-left)
